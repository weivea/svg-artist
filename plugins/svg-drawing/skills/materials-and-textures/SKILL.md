...
description: "Professional material rendering using SVG filters, gradients, and patterns. Covers 18+ materials: metals (chrome, gold, copper, bronze, rust), glass/crystal, wood (5 types), water (still, ocean, rain), fabric (silk, denim, velvet, leather), stone (marble, granite, sandstone), skin (6 tones with SSS), fur/hair, brick/concrete, ice/frost, fire/smoke, clouds/fog, sand/earth, paper/parchment, and enamel/ceramic. Includes material interaction rules, lighting consistency, and PBR-inspired property tables."
---
