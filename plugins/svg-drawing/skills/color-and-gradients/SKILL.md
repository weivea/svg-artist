...
description: "Professional color theory, gradient engineering, pattern design, and color manipulation for SVG. Covers color interpolation spaces, gradient units, feColorMatrix color grading, feComponentTransfer tone curves, mesh gradient simulation, gradient inheritance, and accessibility-safe palettes."
---
