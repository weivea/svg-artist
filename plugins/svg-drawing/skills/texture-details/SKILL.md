...
description: "Comprehensive texture rendering for SVG illustration: complete fabric fold system (7 classical types with shadow/highlight placement), fabric material behavior (silk, denim, cotton, velvet, chiffon with SVG techniques), leather grain, metallic surfaces, wood grain patterns (straight grain, knots, species palettes), stone and concrete textures (rough stone, marble, concrete, cobblestone), glass and transparency effects (clear, frosted, stained, refraction), woven fabric patterns (plain, twill, herringbone, basket weave, knit), rust and weathering (rust spots, corrosion, copper patina, peeling paint), paper and parchment (clean, aged, crumpled, torn edges), texture-to-style adaptation guidelines, and performance optimization for SVG filters."
---
